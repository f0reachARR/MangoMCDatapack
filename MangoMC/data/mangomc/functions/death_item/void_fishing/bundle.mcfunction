...
# バンドルを用意する
data modify storage mangomc: InventoryItem set value {id:"minecraft:bundle",Count:1b,tag:{Items:[],UsedVoidBundle:1b,display:{Name:'[{"text":"***","color":"gold","obfuscated":true},{"text":"虚無のバンドル","color":"gold","obfuscated":false},{"text":"***","color":"gold","obfuscated":true}]'}}}
